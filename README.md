...
A **Lumi** é uma solução desenvolvida para integrar agentes de Inteligência Artificial com o Jira. O objetivo é automatizar o planejamento do roadmap, a criação de histórias de usuário e a quebra de tarefas, aumentando a eficiência e a qualidade do backlog no processo de desenvolvimento de software.
